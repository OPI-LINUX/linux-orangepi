...
if [ -f //home/minimyth/minimyth2/images/build/usr/include/ncursesw/ncurses.h ]; then
	echo cflags=\"-D_GNU_SOURCE -I//home/minimyth/minimyth2/images/build/usr/include/ncursesw\"
	echo libs=\"-lncursesw\"
	exit 0
fi

if [ -f //home/minimyth/minimyth2/images/build/usr/include/ncurses/ncurses.h ]; then
	echo cflags=\"-D_GNU_SOURCE -I//home/minimyth/minimyth2/images/build/usr/include/ncurses\"
	echo libs=\"-lncurses\"
	exit 0
fi
